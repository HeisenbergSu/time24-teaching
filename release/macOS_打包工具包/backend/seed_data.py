...
practice_questions = [
    {
        'question': '火车票上写着是什么时候？',
        'options': json.dumps(['早上10点', '晚上10点', '上午10点', '下午2点']),
        'correct_answer': '上午10点',
        'module_type': 'practice'
    },
    {
        'question': '火车站的电子屏显示K284次列车将在15:52发车。为了赶上这趟火车，你应该几点到达火车站呢？',
        'options': json.dumps(['下午4点', '下午3点半', '20:00', '17:50']),
        'correct_answer': '下午3点半',
        'module_type': 'practice'
    },
    {
